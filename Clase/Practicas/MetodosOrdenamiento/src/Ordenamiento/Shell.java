 ...
 * Hi = Hi-1 * 3 + 1
 * H:1,4,13,40...
 * Ventajas contra el de inserción:
 * El numero muy bajo al final de todo implica que tenga que desplazar todo el vector para colocarlo al comienzo.
 * En cambio acá se acomoda a la posición casi final al comienzo. HAsta 3 desplazamientos por elemento como maximo.
 * 
 * EJEMPLOAORDENAR
 ...
 * AEDANJEEOLOMPRR
 * 
 * PASADA 3 - H=1 ( PASARIA A SER INSERCIÓN PURA )
 * AEDANJEEOLOMPRR
 * 
 * AE
 * ADE
